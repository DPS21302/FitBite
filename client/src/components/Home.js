...
const HowItWorksSection = () => {
    ...
    return (
        <motion.section
            className="bg-gradient-to-br from-blue-100 to-purple-200 py-12 md:py-24 min-h-screen flex items-center justify-center overflow-hidden"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            transition={{ duration: 1 }}>
            <motion.div
                className="absolute top-10 left-10 md:top-20 md:left-20 w-12 h-12 md:w-16 md:h-16 bg-white bg-opacity-20 rounded-full"
                variants={circleVariants}
                animate="animate"
            />
            <motion.div
                className="absolute bottom-10 right-10 md:bottom-20 md:right-20 w-16 h-16 md:w-24 md:h-24 bg-white bg-opacity-20 rounded-full"
                variants={circleVariants}
                animate="animate"
            />
            ...
            <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
                <motion.h2
                    className="text-3xl md:text-5xl font-extrabold text-center text-black mb-8 md:mb-16"
                    initial={{ y: -50, opacity: 0 }}
                    animate={{ y: 0, opacity: 1 }}
            ...
            Your Journey to a Healthier You
                ...
                <div className="relative perspective-1000">
                    <AnimatePresence mode="wait">
                        <motion.div
                            ...
                            animate="visible"
                            exit="exit"
                            className={`${cardColors[activeStep]} rounded-2xl p-6 md:p-8 shadow-2xl`}
                            style={{
                                width: "100%",
                                maxWidth: "600px",
                            ...
                            <motion.div
                                ...
                                <div className="w-16 h-16 md:w-24 md:h-24 bg-white rounded-full flex items-center justify-center shadow-lg">
                                    {React.createElement(
                                        steps[activeStep].icon,
                                        {
                                            className: `text-2xl md:text-4xl ${iconColors[activeStep]}`,
                                        }
                                    )}
                                </div>
                            </motion.div>
                            <motion.h3
                                className="text-2xl md:text-3xl font-bold text-gray-800 text-center mb-2 md:mb-4"
                            ...
                            <motion.p
                                className="text-base md:text-xl text-gray-600 text-center"
                                initial={{ y: 20, opacity: 0 }}
                                animate={{ y: 0, opacity: 1 }}
                    ...
                    <motion.button
                        className="absolute top-1/2 left-0 md:left-[170px]  bg-white text-teal-500 rounded-full p-2 md:p-3 shadow-lg"
                        onClick={prevStep}
                        whileHover={{ scale: 1.1, backgroundColor: "#e6e6e6" }}
                        whileTap={{ scale: 0.9 }}>
                        <FaChevronLeft size={20} />
                    </motion.button>

                    <motion.button
                        className="absolute top-1/2 right-0 md:right-[170px]  bg-white text-teal-500 rounded-full p-2 md:p-3 shadow-lg"
                        onClick={nextStep}
                        whileHover={{ scale: 1.1, backgroundColor: "#e6e6e6" }}
                        whileTap={{ scale: 0.9 }}>
                ...
                <div className="mt-8 md:mt-16 flex justify-center space-x-2 md:space-x-4">
                    {steps.map((_, index) => (
                        <motion.div
                            key={index}
                            className={`w-3 h-3 md:w-4 md:h-4 rounded-full ${
                                index === activeStep
                                    ? cardColors[index] // Use the full card color class for active step
                                    : "bg-gray-400"
                            }`}
                ...
                {/* <motion.div
                    ...
                    <motion.button
                        className="px-6 py-3 md:px-8 md:py-4 bg-white text-teal-500 rounded-full font-bold text-base md:text-lg shadow-lg"
                        whileHover={{
                            scale: 1.05,
...
const TestimonialsSection = () => {
    const testimonials = [
        {
            name: "Sarah L.",
            quote: "This app has completely transformed my relationship with food. I've never felt healthier!",
            avatar: "👩‍🦰",
            rating: 5,
        ...
        {
            name: "Mike R.",
            quote: "The personalized meal plans are fantastic. I'm losing weight without feeling deprived.",
            avatar: "👨‍🦲",
            rating: 5,
        ...
        {
            name: "Emily T.",
            quote: "I love how easy it is to track my progress. It keeps me motivated to stick to my goals.",
            avatar: "👩‍🦱",
            rating: 4,
            profession: "Teacher",
        ...
        {
            name: "John S.",
            quote: "Using this app helped me understand nutrition better. I feel more confident in my food choices now.",
            avatar: "👨",
            rating: 5,
        ...
        {
            name: "Sophie M.",
            quote: "The support from the community in this app is incredible. It's like having a personal cheerleading squad!",
            avatar: "👩",
            rating: 5,
    ...
    const faqs = [
        {
            ...
            answer: "Our AI analyzes your health goals, dietary preferences, and lifestyle to create a tailored meal plan just for you.",
        },
        {
            question: "Can I change my meal plan?",
            answer: "Absolutely! You can customize your meal plan at any time to fit your changing needs and preferences.",
        },
        {
            question:
                "Is the app suitable for people with dietary restrictions?",
            answer: "Yes, our app caters to various dietary needs including vegetarian, vegan, gluten-free, and more.",
        },
        {
            question: "How often should I update my progress?",
            answer: "We recommend updating your progress weekly for the best results and most accurate adjustments to your plan.",
        },
        {
            question: "What is BMI (Body Mass Index)?",
            answer: "BMI is a measurement that indicates whether you are underweight, normal weight, overweight, or obese based on your height and weight.",
        },
        {
            question: "How can I improve my BMI?",
            answer: "You can improve your BMI by maintaining a balanced diet, exercising regularly, and monitoring your weight consistently.",
        },
        {
            question: "What is BMR (Basal Metabolic Rate)?",
            answer: "BMR is the number of calories your body needs to maintain basic physiological functions while at rest.",
        },
        {
            question: "How can I calculate my BMR?",
            answer: "You can use online BMR calculators that consider factors like age, gender, weight, and height to estimate your BMR.",
        },
        {
            question: "Why is BMR important?",
            answer: "BMR helps determine your daily calorie needs, which is crucial for weight management and maintaining a healthy metabolism.",
        },
        {
            question: "What is body fat percentage?",
            answer: "Body fat percentage is the proportion of fat tissue to lean tissue in your body. It is an important indicator of overall health and fitness.",
        },
        {
            question: "How can I reduce body fat percentage?",
            answer: "Reducing body fat percentage involves a combination of regular exercise, a balanced diet, and maintaining a calorie deficit.",
        },
        {
            question: "What is considered a healthy body fat percentage?",
            answer: "Healthy body fat percentage ranges vary by age and gender, but generally, lower body fat percentages are associated with better health outcomes.",
        },
    ];
